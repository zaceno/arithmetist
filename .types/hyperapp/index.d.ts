...
declare module "hyperapp" {
    ...
    function memo<S, D extends Indexable = Indexable>(view: (data: D) => VNode<S>, data: D): VNode<S>
    ...
    type EventActions<S> = {
        [K in keyof EventsMap]: Action<S, EventsMap[K]> | readonly [action: Action<S>, payload: unknown]
    }
    ...
    type Props<S> = Readonly<
        Partial<
            Omit<HTMLElement, keyof (DocumentAndElementEventHandlers & ElementCSSInlineStyle & GlobalEventHandlers)> &
    ...
    type ElementVNode<S> = {
        ...
        events?: Record<string, Action<S> | readonly [action: Action<S>, payload: unknown]>
