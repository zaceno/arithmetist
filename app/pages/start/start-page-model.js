import TablePicker from "./table-picker/table-picker-model.js"
import Modal from "./app-info-modal/modal/modal-model.js"

/**
 * @typedef State
 * @prop {import('./table-picker/table-picker-model.js').State} tables
 * @prop {import('./app-info-modal/modal/modal-model.js').State} info
 */
 ...
 * @prop {import('./table-picker/table-picker-model.js').Model<S>} tables
 * @prop {import('./app-info-modal/modal/modal-model.js').Model<S>} info
 * @prop {Action<S, any>} Next
 */
